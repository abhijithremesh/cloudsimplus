...
public class MaxMinPolicy1 {

    MyBroker myBroker;
    List<Vm> vmList;

    MaxMinPolicy1 (MyBroker myBroker, List<Vm> vmList){
    ...
    public void schedule(){
        ...
        for(int c=0; c< clist.size(); c++){
            ...
            myBroker.bindCloudletToVm(cloudletList.get(maxCloudlet), vmList.get(minVm));
            System.out.println(cloudletList.get(maxCloudlet)+" bound to "+vmList.get(minVm));
