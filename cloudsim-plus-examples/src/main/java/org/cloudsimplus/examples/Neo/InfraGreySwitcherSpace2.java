...
public class InfraGreySwitcherSpace2 {
    ...
    ArrayList<Integer> solutionCandidate = new ArrayList<>(Arrays.asList(0, 1, 2, 3, 4, 5, 2, 7, 8, 2, 0, 1, 3, 7, 5, 4, 7, 1, 4, 5, 0, 5, 2, 3));
    ...
    public static void main(String[] args) {
        new InfraGreySwitcherSpace2();
    }

    private InfraGreySwitcherSpace2() {
    ...
    private void pauseSimulation( EventInfo evt) {
        ...
        if((int)evt.getTime() == INTERVAL * (heuristicIndex + 1)){
            ...
            for (Cloudlet c : cloudletList
                ...
                //c.assignToDatacenter(datacenter0);
                //c.setBroker(broker0);
                //c.setVm(Vm.NULL);
            }
