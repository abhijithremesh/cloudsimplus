...
public class GA {
    ...
    public void computeFitness(List<Chromosome> chromosomeList, double w1, double w2, double w3){
        ...
        //this.makespanList = this.makespanList.stream().map(f->((Integer.MAX_VALUE-f)/(Integer.MAX_VALUE - Integer.MIN_VALUE))*100).collect(Collectors.toList());
        //this.flowTimeList = this.flowTimeList.stream().map(f->((Integer.MAX_VALUE-f)/(Integer.MAX_VALUE - Integer.MIN_VALUE))*100).collect(Collectors.toList());
...
//    }
    ...
    public void clearGenerationAfterOptimization(){
        generationBestFitnessValueList.clear();
        generationBestChromosomeList.clear();
    }
