...
public class AssessSingleHeuristic {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        new AssessSingleHeuristic();
    }

    private AssessSingleHeuristic() throws FileNotFoundException {
        ...
        /*
        String fileName = "Z:/cloudsimplus/cloudsim-plus-examples/src/main/java/org/cloudsimplus/examples/Model/out.txt";
