...
public class AssessSingleChromosome {
    ...
    public static void main(String[] args) {
        new AssessSingleChromosome();
    }

    private AssessSingleChromosome() {
    ...
    public SingleChromosome convertToChromosome(String n){
        ArrayList<SingleGene> newChromosome = new ArrayList<>();
        ...
        SingleChromosome chro = new SingleChromosome(newChromosome);
        return chro;
    }
